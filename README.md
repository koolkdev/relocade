...
stack operations, binary32/binary64 loads and binary80 transfers. x87 arithmetic
and binary32/binary64 stores, real mode, privilege transitions, interrupt delivery
and SIMD are not implemented.
