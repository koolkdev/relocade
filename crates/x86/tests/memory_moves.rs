...
struct Image {
    cpu: [u8; 152],
    guest: Vec<(u32, Vec<u8>)>,
    machine: Vec<(u32, Vec<u8>)>,
}
...
fn check(module: &ModuleFile, flags: &[&str], name: &str, image: &Image, steps: &[Step<'_>]) {
